...
graph TD
  subgraph GrafoClass
    ...
    busca_em_profundidade_iterativa[busca_em_profundidade_iterativa]
  end
  ...
  subgraph Exemplo
    ...
    busca_em_profundidade[busca_em_profundidade_iterativa 1]
  end

  Grafo --> __init__
  Grafo --> adicionar_vertice
  Grafo --> adicionar_aresta
  Grafo --> busca_em_profundidade_iterativa
